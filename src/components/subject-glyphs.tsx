...
/**
 * Кастомные линейные иконки предметов (не из icon-паков). Рисуются штрихом
 * currentColor, поэтому цвет задаётся через className/color родителя.
 */
...
export const CompassIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg {...base(props)}>
        ...
        <path d="M6.8 20l1.6-.9M17.2 20l-1.6-.9" />
        <path d="M9 15.5h6" />
    </svg>
);
...
export const OpenBookIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg {...base(props)}>
        <path d="M12 6.2C9.5 4.6 6 4.3 3.5 5.1V18c2.5-.8 6-.5 8.5 1.1" />
        <path d="M12 6.2c2.5-1.6 6-1.9 8.5-1.1V18c-2.5-.8-6-.5-8.5 1.1" />
        <path d="M12 6.2v13" />
    </svg>
);
...
export const LeafIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg {...base(props)}>
        <path d="M20 4C10 4 4 9.5 4 19c0 0 0 0 0 0 9.5 0 15-6 16-15Z" />
...
export const ColumnIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg {...base(props)}>
        <path d="M4 5h16" />
        <path d="M5.5 7.5h13" />
        <path d="M8 7.8v9.4M12 7.8v9.4M16 7.8v9.4" />
        <path d="M5.5 17.2h13" />
        <path d="M4 20h16" />
    </svg>
);
...
export const BookIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg {...base(props)}>
        <path d="M6 4h10a2 2 0 0 1 2 2v13a1 1 0 0 1-1 1H7a2 2 0 0 1-2-2V5a1 1 0 0 1 1-1Z" />
        <path d="M6 16.5h11" />
    </svg>
);
