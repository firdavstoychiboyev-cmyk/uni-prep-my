 ...
 * из subject-theme. Используются в больших карточках на /subjects.
 */
...
const MathIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <linearGradient id="ma-tri" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffffff" stopOpacity=".85" /><stop offset="1" stopColor="#bfe0ff" stopOpacity=".45" /></linearGradient>
            <linearGradient id="ma-rul" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#eaf7ff" stopOpacity=".95" /><stop offset=".5" stopColor="#7dd3fc" stopOpacity=".82" /><stop offset="1" stopColor="#86efac" stopOpacity=".9" /></linearGradient>
        </defs>
        <g transform="rotate(-12 120 130)">
            <path d="M40 44 L40 210 L206 210 Z" fill="url(#ma-tri)" stroke="#ffffff" strokeOpacity=".85" strokeWidth="3" />
        ...
        <g transform="rotate(52 158 132)">
            <rect x="124" y="26" width="46" height="196" rx="10" fill="url(#ma-rul)" stroke="#ffffff" strokeOpacity=".85" strokeWidth="3" />
...
const EnglishIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <linearGradient id="bk-l" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffffff" /><stop offset="1" stopColor="#ffe1f0" /></linearGradient>
            <linearGradient id="bk-r" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffd7ec" /><stop offset="1" stopColor="#ff9ecb" /></linearGradient>
            <linearGradient id="bk-pen" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffe9a8" /><stop offset="1" stopColor="#f5ad2b" /></linearGradient>
        </defs>
        <ellipse cx="132" cy="220" rx="104" ry="16" fill="#7a1050" opacity=".2" />
        <path d="M128 66 C96 48 56 48 30 62 L30 194 C56 180 96 180 128 200 Z" fill="url(#bk-l)" />
        <path d="M128 66 C160 48 204 48 230 62 L230 194 C204 180 160 180 128 200 Z" fill="url(#bk-r)" />
        ...
        <g transform="rotate(33 176 120)">
            <rect x="166" y="40" width="22" height="140" rx="7" fill="url(#bk-pen)" />
...
const NativeIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <linearGradient id="pn-b" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffffff" stopOpacity=".95" /><stop offset="1" stopColor="#ddd0ff" stopOpacity=".7" /></linearGradient>
            <linearGradient id="pn-n" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#e9deff" /><stop offset="1" stopColor="#a78bfa" /></linearGradient>
        </defs>
        <ellipse cx="130" cy="222" rx="86" ry="14" fill="#3b1080" opacity=".2" />
        <g transform="rotate(45 130 130)">
            <rect x="116" y="22" width="28" height="150" rx="14" fill="url(#pn-b)" stroke="#ffffff" strokeOpacity=".8" strokeWidth="2.5" />
            ...
            <path d="M116 172 L144 172 L130 218 Z" fill="url(#pn-n)" stroke="#ffffff" strokeOpacity=".6" strokeWidth="2" />
...
const BiologyIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <linearGradient id="lf-a" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffffff" /><stop offset="1" stopColor="#d6ffe6" /></linearGradient>
            <linearGradient id="lf-b" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#bbf7d0" /><stop offset="1" stopColor="#4ade80" stopOpacity=".85" /></linearGradient>
        </defs>
        <ellipse cx="132" cy="220" rx="84" ry="14" fill="#064e2b" opacity=".2" />
        <path d="M134 32 C58 66 46 168 84 216 C170 202 218 112 134 32 Z" fill="url(#lf-a)" />
        <path d="M134 32 C182 92 170 168 84 216 C96 142 108 78 134 32 Z" fill="url(#lf-b)" />
...
const HistoryIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <linearGradient id="cl-a" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#ffffff" /><stop offset="1" stopColor="#ffe6b8" /></linearGradient>
            <linearGradient id="cl-b" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#fff6e2" /><stop offset="1" stopColor="#fbbf24" stopOpacity=".85" /></linearGradient>
        </defs>
        <ellipse cx="130" cy="224" rx="98" ry="14" fill="#7c2d00" opacity=".2" />
        <path d="M130 34 L214 88 L46 88 Z" fill="url(#cl-a)" />
        <path d="M130 34 L214 88 L130 88 Z" fill="#f7c977" fillOpacity=".55" />
        <rect x="54" y="92" width="152" height="16" rx="4" fill="url(#cl-b)" />
        <g fill="url(#cl-a)"><rect x="62" y="114" width="24" height="78" rx="4" /><rect x="118" y="114" width="24" height="78" rx="4" /><rect x="174" y="114" width="24" height="78" rx="4" /></g>
        ...
        <rect x="46" y="194" width="168" height="16" rx="4" fill="url(#cl-b)" />
    </svg>
);
...
const PhysicsIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <radialGradient id="at-n" cx="40%" cy="40%" r="70%"><stop offset="0" stopColor="#ffffff" /><stop offset="1" stopColor="#67e8f9" /></radialGradient>
        </defs>
        ...
        <circle cx="130" cy="128" r="22" fill="url(#at-n)" />
...
const ChemistryIllustration: Glyph = (props) => (
    <svg viewBox="0 0 260 260" {...props}>
        <defs>
            <linearGradient id="fl-g" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#ffffff" stopOpacity=".9" /><stop offset="1" stopColor="#ffe1e6" stopOpacity=".6" /></linearGradient>
            <linearGradient id="fl-liq" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#fda4af" /><stop offset="1" stopColor="#f43f5e" /></linearGradient>
        </defs>
        <ellipse cx="130" cy="226" rx="80" ry="13" fill="#7a0f2a" opacity=".2" />
        <path d="M106 44 L154 44 L154 102 L196 186 C203 202 191 218 172 218 L88 218 C69 218 57 202 64 186 L106 102 Z" fill="url(#fl-g)" stroke="#ffffff" strokeOpacity=".7" strokeWidth="3" />
        <path d="M86 150 L174 150 L196 186 C203 202 191 218 172 218 L88 218 C69 218 57 202 64 186 Z" fill="url(#fl-liq)" />
